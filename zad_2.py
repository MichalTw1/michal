...
class Book:
    ...
    def __str__(self):
        return f"Book by {self.author_name} {self.author_surname} (from {self.library})"
...
class Order:
    ...
    def __str__(self):
        ...
        return f"Order by {self.student} handled by {self.employee}. Books: {book_list}"

lib1 = Library("Warsaw", "Main St", "00-001", "8-16", "123456")
lib2 = Library("Krakow", "Old St", "30-001", "9-17", "654321")

emp1 = Employee("John", "Doe", "2020-01-01", "1990-05-05", "Warsaw", "Side St", "00-002", "111")
emp2 = Employee("Jane", "Smith", "2021-02-01", "1992-06-06", "Krakow", "New St", "30-002", "222")
emp3 = Employee("Bob", "Brown", "2019-03-01", "1988-07-07", "Warsaw", "Big St", "00-003", "333")
